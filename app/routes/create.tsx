      ...
      <View style={styles.container}>
        ...
        <View style={styles.bottomDock}>
          <View style={styles.actionBar}>
            ...
            {/* “fixos” placeholder (para evoluir depois) */}
            <TouchableOpacity style={styles.actionBtn} onPress={() => setMsg("Opção de imagem (em breve).")}>
            ...
            {/* último ícone: abre bottom sheet */}
          ...
          >
            {isSaving ? (
              ...
              <Text style={styles.saveText}>Salvar rota</Text>
            )}
          </TouchableOpacity>
